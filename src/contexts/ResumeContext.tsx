  ...
  projects: [
    {
      ...
      description:
        "Built a full-stack e-commerce platform with React frontend, Node.js backend, and MongoDB database. Features include user authentication, payment processing, inventory management, and admin dashboard.",
      technologies: [
        "React",
        "Node.js",
        "MongoDB",
    ...
    },
    {
      ...
      description:
        "Developed a collaborative task management application with real-time updates, drag-and-drop functionality, and team collaboration features. Implemented using React, Socket.io, and Express.",
      technologies: [
        "React",
        "Socket.io",
        "Express",
    ...
    },
    {
      ...
      description:
        "Created a responsive weather dashboard that displays current conditions and forecasts for multiple cities. Integrated with OpenWeatherMap API and includes data visualization charts.",
      technologies: [
        "React",
        "Chart.js",
        "OpenWeatherMap API",
