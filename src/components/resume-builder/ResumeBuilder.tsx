    ...
    <ResumeProvider>
      <div className="h-screen bg-gray-50 flex flex-col overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row flex-1 min-h-0">
          ...
          <div className="w-full lg:w-[40%] bg-white border-r border-gray-200 flex flex-col min-h-0 pb-[40px]">
          ...
          <div className="w-full lg:w-[60%] bg-gray-100 flex flex-col min-h-0 resume-preview pb-[40px]">
            <div className="flex-1 overflow-y-auto">
              <ResumePreview />
            </div>
          </div>
