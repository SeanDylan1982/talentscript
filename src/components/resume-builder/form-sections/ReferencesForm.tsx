    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="text-base font-medium text-gray-900">Professional References</h3>
        </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
        <p className="text-sm text-blue-800">
          <strong>Tip:</strong> Include 2-3 professional references who can speak to your work experience and character. 
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-400 mb-4">
              Add professional contacts who can vouch for your work and character.
            </p>
      ...
      {references.length > 0 && (
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
          <p className="text-sm text-amber-800">
            <strong>Remember:</strong> Contact your references before submitting applications to ensure they're 
            available and willing to provide a positive recommendation.
          </p>
        </div>
      )}
    </div>
