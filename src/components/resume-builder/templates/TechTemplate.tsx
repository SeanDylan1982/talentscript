...
export function TechTemplate({ data }: TemplateProps) {
  ...
  const renderSection = (section: typeof sections[0]) => {
    switch (section.type) {
      case 'personalInfo':
        return (
          <div key={section.id} className="bg-gray-50 p-6 border-b border-gray-200">
      ...
      case 'summary':
        ...
        return (
          <div key={section.id} className="p-6 border-b border-gray-200">
            <h2 className="text-lg font-semibold mb-3 flex items-center text-gray-800" style={{ fontFamily: customization.fontFamily }}>
              <Cpu className="w-4 h-4 mr-2" style={{ color: customization.accentColor }} />
              Technical Profile
            </h2>
      ...
      case 'skills':
        ...
        return (
          <div key={section.id} className="p-6 border-b border-gray-200">
            <h2 className="text-lg font-semibold mb-4 flex items-center text-gray-800" style={{ fontFamily: customization.fontFamily }}>
